...
function generateSchemas() {
    ...
    fs_1.writeFileSync(`oapi/definitions.json`, JSON.stringify({ definitions: schemas }, null, 2), {
        encoding: "utf8"
    });
    const specstring = fs_1.readFileSync("oapi/openapi.json", "utf8");
    const spec = JSON.parse(specstring);
    spec["components"]["schemas"] = schemas;
    fs_1.writeFileSync(`oapi/openapi-defs.json`, JSON.stringify(spec, null, 1), {
        encoding: "utf8"
    });
