...
function CurrentUserPlugin(fastify, config, done) {
    var _this = this;
    fastify.decorateRequest("user", null).after(function (err) {
        fastify.addHook("preHandler", function (request, reply, done) { return __awaiter(_this, void 0, void 0, function () {
            var token, db, dbToken, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        token = request["cookies"]["auth._token.local"];
                        console.log("token = ", token);
                        if (!token) return [3 /*break*/, 2];
                        db = fastify["db"];
                        return [4 /*yield*/, db.manager.findOne(Token_1.Token, token)];
                    case 1:
                        dbToken = _a.sent();
