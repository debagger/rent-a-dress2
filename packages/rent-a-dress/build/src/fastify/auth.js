    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            fastify.post("/api/auth/login", {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    var foundUser, token, item, newToken, savedToken, error_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 5, , 6]);
                            ...
                            case 1:
                                ...
                                token = config.hash(Date.now() + "." + foundUser.username + "." + foundUser.password);
                                return [4 /*yield*/, Users.findOne({
                            ...
                            case 2:
                                ...
                                newToken = new Token_1.Token();
                                newToken.user = item;
                                newToken.token = token;
                                return [4 /*yield*/, Tokens.save(newToken)];
                            case 3:
                                savedToken = _a.sent();
