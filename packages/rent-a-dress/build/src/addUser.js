    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                token.token = '123';
                token.user = user;
                return [4 /*yield*/, connection.manager.save(token)];
            case 2:
                _a.sent();
                console.log("User saved");
                return [4 /*yield*/, connection.manager.findOne(User_1.User, { username: user.username })];
            case 3:
                savedUser = _a.sent();
