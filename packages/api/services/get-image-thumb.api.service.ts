...
import { GetImageThumbResponse } from '../typings';
// Schemas
 ...
 */
@Injectable()
export class GetImageThumbService extends ApiService<
  GetImageThumbResponse,
  null,
  null
> {
  ...
  protected get schema(): ApiSchema {
    return {
      ...
      request: null,
      response: {
        '200': { 'image/jpeg': { type: 'string', format: 'binary' } },
        '404': { 'text/plain': { type: 'string' } }
      }
    } as any;
  }
