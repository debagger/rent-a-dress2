...
import { GetUserByTokenResponse } from '../typings';
// Schemas
 ...
 */
@Injectable()
export class GetUserByTokenService extends ApiService<
      ...
      response: {
        '200': {
          'application/json': {
            ...
            properties: {
              user: {
                $ref: 'schema.e36dad2dddf84baa934cf1#/components/schemas/User'
              }
            }
          }
        },
        '404': {
          'text/plain': { type: 'string', default: 'User or token not found' }
        }
      }
    } as any;
  }
