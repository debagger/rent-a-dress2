...
import { GetImagesForCatalogItemResponse } from '../typings';
// Schemas
 ...
 */
@Injectable()
export class GetImagesForCatalogItemService extends ApiService<
  GetImagesForCatalogItemResponse,
  null,
  null
> {
      ...
      response: {
        '200': {
          'application/json': {
            type: 'array',
            items: {
              $ref: 'schema.e36dad2dddf84baa934cf1#/components/schemas/Image'
            }
          }
        }
      }
