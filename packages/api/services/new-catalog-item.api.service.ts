...
import { NewCatalogItemResponse, NewCatalogItemRequest } from '../typings';
// Schemas
 ...
 */
@Injectable()
export class NewCatalogItemService extends ApiService<
  NewCatalogItemResponse,
  NewCatalogItemRequest,
  null
> {
  ...
  protected get schema(): ApiSchema {
    return {
      ...
      request: {
        'application/json': {
          $ref: 'schema.e36dad2dddf84baa934cf1#/components/schemas/catalogItem'
        }
      },
      response: {
        '200': {
